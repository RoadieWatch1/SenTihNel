      ...
      <ScrollView style={styles.scroll} contentContainerStyle={styles.content}>
        ...
        <View style={styles.methodCard}>
          ...
          <View style={styles.methodContent}>
            ...
            <Text style={styles.methodDesc}>
              {Platform.OS === "android"
                ? "Press the red SOS button in the app or use the floating overlay button. Quick and reliable in any situation."
                : "Press the red SOS button in the app. For fastest off-screen access, use Back Tap (see iOS Quick Access below)."}
            </Text>
          </View>
        </View>
